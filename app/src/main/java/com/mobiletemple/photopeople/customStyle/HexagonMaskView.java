...
import com.mobiletemple.photopeople.shapes.PolygonShape;
import com.mobiletemple.photopeople.shapes.PolygonShapeSpec;
import com.mobiletemple.photopeople.shapes.RegularPolygonShape;

@SuppressLint("AppCompatCustomView")
class HexagonImageView extends ImageView {
    ...
    public HexagonImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            mPolygonShapeSpec.setCornerRadius(attributes.getFloat(R.styleable.PolygonImageView_poly_corner_radius, 1f));
            ...
            mPolygonShapeSpec.setBorderColor(attributes.getColor(R.styleable.PolygonImageView_poly_border_color, R.color.colorPrimary));
            mPolygonShapeSpec.setBorderWidth(attributes.getDimension(R.styleable.PolygonImageView_poly_border_width, 1));
    ...
    private static Bitmap drawableToBitmap(Drawable drawable) {
        ...
        try {
            ...
            //Log.e("HexagonImageView", "OutOfMemory during bitmap creation");
            return null;
        }
