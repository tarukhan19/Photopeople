...
public class HiredFreeWaitAdapter extends RecyclerView.Adapter<HiredFreeWaitAdapter.MyViewHolder> {
    private Context mContext;
    private ArrayList<Hire_free_waitDTO> hire_free_waitDTOS;
    private int mSelectedItemPosition=-1;
    String enddateS,startdateS;
    public HiredFreeWaitAdapter(Context mContext, ArrayList<Hire_free_waitDTO> hire_free_waitDTOS)
    {
        this.mContext = mContext;
        this.hire_free_waitDTOS = hire_free_waitDTOS;
    }
    @Override
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final Hire_free_waitDTO freelancer = hire_free_waitDTOS.get(position);
    ...
    public int getItemCount() {
        return hire_free_waitDTOS != null ? hire_free_waitDTOS.size() :0;}
