...
public class StudioJob_completeAdapter  extends RecyclerView.Adapter<StudioJob_completeAdapter.MyViewHolder> {
    private Context mContext;
    private ArrayList<Myjob_completeDTO> myjob_completeDTOS;
    private int mSelectedItemPosition=-1;
    String enddateS,startdateS;
    public StudioJob_completeAdapter(Context mContext, ArrayList<Myjob_completeDTO> myjob_completeDTOS)
    {
