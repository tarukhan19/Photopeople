...
import com.mobiletemple.photopeople.adapter.BuyNewprodAdapter;
 ...
 */
public class BuyNewProdct extends Fragment {
    RecyclerView prodlistrecycle;
    BuyNewprodAdapter productListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_buy_new_prodct, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        productListAdapter = new BuyNewprodAdapter(getActivity(), productListDTOS);
    ...
    private void loadProductListCategoryWise()
    {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, Endpoints.NEW_PRODUCT_LIST,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        dialog.dismiss();
                        Log.e("NEW_PRODUCT_LIST", response);
                        ...
                        try
                        {
                            ...
                            if (status == 200 && message.equals("success"))
                            {
                                ...
                                for (int x = 0; x < product_list.length(); x++)
                                {
                                    ...
                                    BuyNewProdDTO productListDTO = new BuyNewProdDTO();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("product_condition","1" );
