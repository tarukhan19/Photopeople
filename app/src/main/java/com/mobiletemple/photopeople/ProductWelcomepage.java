...
public class ProductWelcomepage extends AppCompatActivity {
    private int stage;
    String first_name,freelancerId,Mobile_no,email,quoteId,paymentid,amount;
    String randomString;
    Intent intent;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_welcomepage);
        pd = new ProgressDialog(ProductWelcomepage.this);
        intent=getIntent();
        ...
        doneBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ProductWelcomepage.this, HomePage.class);
    ...
    class PaymentEntryTask extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... strings) {
            ...
            try
            {
                ...
                String result = comm.getStringResponse(Endpoints.PRODUCT_PAYMENT, ob);
                Log.e("PRODUCT_PAYMENT",ob.toString());
                return result;
            } catch (Exception e) {
                e.printStackTrace();
                return e.getMessage();
            ...
            try {
                if (s != null) {
                    ...
                    if (status == 200 && message.equalsIgnoreCase("success")) {
                        new SweetAlertDialog(ProductWelcomepage.this, SweetAlertDialog.SUCCESS_TYPE)
                        ...
                        Toast.makeText(ProductWelcomepage.this, message, Toast.LENGTH_SHORT).show();
                    }
                }
            } catch (Exception ex) {
