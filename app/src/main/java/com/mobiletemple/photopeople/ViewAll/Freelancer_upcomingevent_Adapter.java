...
public class Freelancer_upcomingevent_Adapter extends RecyclerView.Adapter<Freelancer_upcomingevent_Adapter.MyViewHolder> {
    private Context mContext;
    private ArrayList<My_Job_ProcessDTO> my_job_processDTOS;
    private int mSelectedItemPosition=-1;
    String enddateS,startdateS;
    public Freelancer_upcomingevent_Adapter(Context mContext, ArrayList<My_Job_ProcessDTO> my_job_processDTOS)
    {
