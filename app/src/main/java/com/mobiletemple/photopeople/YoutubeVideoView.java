...
import com.mobiletemple.photopeople.util.Config;
...
public class YoutubeVideoView extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
...
//            String url = sp.getString("url", "");
            ...
            //Log.e("DATA", "1>>>" + getYoutubeVideoId(url));
            player.cueVideo(getYoutubeVideoId(url)); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
